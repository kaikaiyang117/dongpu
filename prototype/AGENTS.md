...
Selected visual direction: use the approved first mock as the source of truth—warm off-white surfaces, heavy black Chinese headings, fresh green primary actions and selection states, soft anatomical line illustrations, large touch targets, minimal shadows, and a focused three-step custom-workout flow.
